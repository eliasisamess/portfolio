...
// This part of our backend application was all written by me and I'm proud of how I got it together.
// Most of what it does, is that it creates metadata from the information fetched from the database.
// Database queries return arrays that are handled, processed and sorted here.
// The metadata is used in frontend, for example to visually show the progress of each subtask-including todo item.
