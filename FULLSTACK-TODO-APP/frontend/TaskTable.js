...
// This is the main component of our frontend app. It renders the array of TODO -items fetched from database by the backend.
// One of our my main focus in this project was to create an app that helps to follow progress on TODO items with multiple subtasks and I'm quite happy with the result, even though the overall design and look of our app is not really fancy and feels a bit outdated.
          ...
          <span
            ...
            onClick={
              rowData.meta.percentage_done !== 100 && !archivedMode
                ? async () => {
                    await axiosConnector.archiveOrCompleteTask(
                      rowData.id,
                      "c+"
                    );
